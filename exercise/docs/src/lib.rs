...
//! A pumpkin is a vernacular term for mature winter squash of species and varieties in the genus Cucurbita that
//! has culinary and cultural significance but no agreed upon botanical or scientific meaning.
...
//! [pupkin_image](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
// the option is `--document-private-items`
